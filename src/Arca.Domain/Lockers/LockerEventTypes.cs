...
public static class LockerEventTypes
{
    ...
    public const string ReservationConsumed = "Locker.ReservationConsumed";
    public const string Assigned = "Locker.Assigned";
    public const string Released = "Locker.Released";
    ...
    public static IReadOnlyList<string> All { get; } =
        [Created, NumberChanged, ZoneChanged, Reserved, ReservationRemoved, ReservationConsumed, Assigned, Released, OutOfService, ServiceTypeChanged, ServiceRestored, Retired];
}
