...
1. **Objetos de transferencia sin correo.** Los listados, búsquedas, informes y exportaciones usan DTO que no tienen ese campo. Solo el DTO de la ficha del alumno y el de la revisión de la importación pueden llevarlo. Una prueba de arquitectura busca propiedades llamadas `Email` en los DTO.
