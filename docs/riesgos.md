...
| E12 | **Zonas y taquillas reales del centro**: zonas, numeración, rangos, estados, llaves, asignaciones y pagos actuales. Se crean una vez y luego se modifican a mano | Carga inicial de `taquilles-i-zones`; decidir si hace falta una importación de taquillas | Etapa 4 del hito 1 (demostración) y antes de instalar en un centro real | Persona responsable con los conserjes | Pendiente; preguntas en `docs/datos-de-ejemplo.md` |
