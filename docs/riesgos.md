...
| E11 | **Revisión legal**: titularidad de los derechos, elección de la GPL-3.0, política de marca (`TRADEMARK.md`) y aviso de privacidad del registro opcional (`docs/registro-de-instalaciones.md`). Registro de la marca «ARCA» (opcional) | Publicar el repositorio y distribuir | Antes de abrir el repositorio | Persona responsable con asesoría legal | Pendiente |
